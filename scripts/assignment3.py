...
def move_bot(move_the_bot, publish_to_cmd_vel, heading):
...
if __name__ == "__main__":
    ...
    odometry_turtle_0 = Odometry()
    odometry_turtle_1 = Odometry()
    odometry_turtle_2 = Odometry()
    odometry_turtle_3 = Odometry()
    odometry_turtle_4 = Odometry()
    odometry_turtle_5 = Odometry()
    odometry_turtle_6 = Odometry()
    odometry_turtle_7 = Odometry()
